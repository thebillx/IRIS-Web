...
const DEFINITIONS: readonly CapabilityDefinition[] = [
  ...
  { id: 'ado.discovery', title: 'Read bound Azure DevOps Board scope and backlog metadata', riskClass: 'LOW', requiredScope: 'PROJECT', mutation: false, implemented: true },
  ...
  { id: 'code_review.start', title: 'Start native read-only LOCAL_NATIVE code review', riskClass: 'MODERATE', requiredScope: 'PROJECT', mutation: true, implemented: true },
  { id: 'code_review.status', title: 'Read native code-review job status', riskClass: 'LOW', requiredScope: 'PROJECT', mutation: false, implemented: true },
  { id: 'code_review.result', title: 'Finalize native code-review receipt into mission evidence', riskClass: 'LOW', requiredScope: 'PROJECT', mutation: true, implemented: true },
