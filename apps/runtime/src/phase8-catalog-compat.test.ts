...
const ADDITIVE_TOOLS = ['ado_discovery', 'ado_workitem_read', 'ado_hierarchy_read', 'ado_context_search', 'owner_approval_resolve', 'workspace', 'fs', 'artifact', 'shell', 'job', 'git', 'code_review'] as const;

describe('Phase 8 two-version catalog compatibility', () => {
  it('AC-IRIS-005 + AC-COMPAT-004 preserves the exact 42-tool 2.3.0 legacy schemas in the 2.6.0 catalog', () => {
